...
# 15ADON Plot
ADON_plot <- ggplot(data, aes(x = Treatment, y = ADON)) +
  geom_boxplot() +
  theme_minimal() +
  ggtitle("15ADON Levels by Treatment")

# Seedmass Plot
SeedMass_plot <- ggplot(data, aes(x = Treatment, y = SeedMass)) +
  geom_boxplot() +
  theme_minimal() +
  ggtitle("Seed Mass by Treatment")
```
...
### **Rendering File in different formats**
```{r}
rmarkdown::render("CodingChallenge4_Markdown.Rmd", output_format = "word_document")
rmarkdown::render("CodingChallenge4_Markdown.Rmd", output_format = "pdf_document")
rmarkdown::render("CodingChallenge4_Markdown.Rmd", output_format = "github_document")
```
